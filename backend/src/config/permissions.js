...
/**
 * ╔══════════════════════════════════════════════════════════════════╗
 * ║           MATRICE DES PERMISSIONS CENTRALISÉE                  ║
 * ║                                                                ║
 * ║  Modifier CE FICHIER pour changer les accès sans toucher       ║
 * ║  au reste du code. Chaque clé = une action, la valeur =       ║
...
const PERMISSIONS = {
  ...
  'calendar.templates':         ['super_admin', 'admin', 'client_admin'],
};
